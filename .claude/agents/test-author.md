...
| Pydantic model / dataclass round-trip (`PdfReadyV1`, `AuditEnvelopeV1`, `CoverageItem`) | build the object, serialize, assert on keys/structure and `schema_version`; no I/O | `packages/datasets_generator_ready/tests/` |
