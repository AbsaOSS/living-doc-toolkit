...
- `packages/services/coverage_matrix/src/living_doc_service_coverage_matrix/schema/doc-source-v1.0.0-schema.json` (validates the `doc-source.json` input; a vendored, pinned copy owned and generated by `living-doc-collector-gh` — see `packages/services/coverage_matrix/src/living_doc_service_coverage_matrix/schema/README.md`)
